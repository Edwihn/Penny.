...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <div className="main-shell"><header className="topbar"><span>My workspace <span className="breadcrumb-divider">/</span> <strong>{page === 'overview' ? 'Overview' : 'Weekly report'}</strong></span><div className="topbar-actions"><span className="local-badge"><span />Saved to local server</span><ThemeToggle /></div></header>
      <main>
